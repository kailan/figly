...
import fastlyUsage from "../input/usage.json"

function generate(): Fig.Spec {
  const usage: Fastly.Usage = fastlyUsage;
...
let output = JSON.stringify(generate());
output = `// Generated by Figly (https://github.com/kailan/figly)\n\nvar completionSpec = ${output}`;
