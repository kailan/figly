// Generated by Figly on Fri, 16 Jul 2021 11:37:02 GMT
      ...
      subcommands: [
        ...
        },
        {
          ...
          options: [
            {
              name: '--addr',
              description: 'The IPv4 address to listen on',
              args: [
                {
                  name: 'addr',
                },
          ...
          subcommands: [
            {
              ...
              options: [
                {
                  name: '--content',
                  description: 'VCL passed as file path or content, e.g. $(cat main.vcl)',
                  args: [
                    {
                      name: 'content',
                    },
          ...
          subcommands: [
            {
              ...
              options: [
                {
                  name: '--content',
                  description: 'VCL snippet passed as file path or content, e.g. $(cat snippet.vcl)',
                  args: [
                    {
                      name: 'content',
                    },
