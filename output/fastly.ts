// Generated by Figly on Thu, 30 Sep 2021 10:31:16 GMT
// https://github.com/kailan/figly
// Fastly CLI version 0.39.2 (45118a7)
// Built with go version go1.17.1 linux/amd64
// 
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            {
              name: '--scope',
              description: 'A comma-separated list of authorization scope',
              args: [
                {
                  name: 'scope',
                },
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                {
                  name: '--type',
                  description: 'The location in generated VCL where the snippet should be placed (e.g. recv, miss, fetch etc)',
                  args: [
                    {
                      name: 'type',
                    },
