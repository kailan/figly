// Generated by Figly on Fri, 07 Jan 2022 10:57:15 GMT
// https://github.com/kailan/figly
// Fastly CLI version 1.4.0 (e91af24)
// Built with go version go1.17.5 linux/amd64
// Viceroy version: viceroy 0.2.7
// 
      ...
      subcommands: [
          ...
          options: [
            {
              ...
              description: 'Do not prompt when project manifest defines [scripts.build]',
              args: [],
            },
            {
              name: '--include-source',
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              description: 'Accept default values for all prompts and perform deploy non-interactively',
              args: [],
            },
            {
              name: '--comment',
        ...
        },
        {
          ...
          options: [
            ...
            {
              name: '--from',
              description: 'Git repository URL, or URL referencing a .zip/.tar.gz file, containing a package template',
              args: [
                {
                  name: 'from',
                },
